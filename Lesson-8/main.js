				...
				if (data.results.length) {
					for (var i = 0; i < data.results.length; i++) {
						...
						.append('<div class=\'main-section__content-item\'>' +
							...
							'<div class=\'main-section__content-infoblock\'><div class=\'main-section__content-comment\'>' + 
							...
							'<div class="main-section__content-tag"> <a href="#">tag1</a>,<a href="#">tag2</a>,<a href="#">tag3</a></div></div>');
					}
				}
			}
		});
